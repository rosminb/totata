...
trait required_columns {
    ...
    protected function add_audiencevisibility_columns(&$requiredcolumns) {
        debugging('\mod_facetoface\rb\traits\required_columns::add_audiencevisibility_columns() has been deprecated and is no longer used. Please use \mod_facetoface\rb\traits\required_joins::add_audiencevisibility_joins() instead to check visibility in reports.', DEBUG_DEVELOPER);

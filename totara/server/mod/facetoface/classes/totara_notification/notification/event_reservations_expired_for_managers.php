...
final class event_reservations_expired_for_managers extends built_in_notification {
    /**
     * @return string
     */
    public static function get_resolver_class_name(): string {
        return event_reservations_expired::class;
    }
    ...
    public static function get_title(): string {
        return get_string('notification_event_reservations_expired_for_managers_title', 'mod_facetoface');
    }
    ...
    public static function get_default_body(): lang_string {
        return new lang_string('notification_event_reservations_expired_for_managers_body', 'mod_facetoface');
    }
    ...
    public static function get_default_subject(): lang_string {
        return new lang_string('notification_event_reservations_expired_for_managers_subject', 'mod_facetoface');
    }

...
* [attendeeslink] - Link to the attendees approval page for the event
...
$string['notification_placeholder_event_all_sessions_layout'] = '
[#sessions]
[session:startdate], [session:starttime] - [session:finishdate], [session:finishtime] [session:timezone]
Duration: [session:duration]
[session:rooms]
...
// Notification event_reservations_cancelled_for_managers.
...
$string['notification_event_reservations_cancelled_for_managers_title'] = 'Reservations cancelled';
$string['notification_event_reservations_cancelled_title'] = 'Reservations cancelled';
// Notification event_reservations_expired_for_managers.

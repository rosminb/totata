...
use mod_facetoface\{exception\signup_exception, signup_status};
 ...
 */
class mod_facetoface_totara_notification_resolver_booking_confirmation_testcase extends testcase {

    private $user = null;
    private $course = null;
    private $seminar = null;
    private $seminarevent = null;
    private $system_custom = null;
    ...
    protected function setUp(): void {
        ...
        $this->system_custom = $notification_generator->create_notification_preference(

...
use mod_facetoface\{signup, seminar, signup_status, totara_notification\placeholder\event as event_placeholder};
 ...
 */
class mod_facetoface_totara_notification_resolver_booking_event_cancelled_testcase extends testcase {

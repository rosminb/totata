...
$string['calculation_label_maximum'] = 'Maximum';
$string['calculation_label_median'] = 'Median';
$string['calculation_label_minimum'] = 'Minimum';
...
$string['excluded_values'] = 'Excluded values';
$string['excluded_values_help_text'] = 'Unanswered questions are always excluded from calculation.';
$string['name'] = 'Response aggregation';
$string['no_available_questions'] = 'No available questions to select';
$string['pluginname'] = 'Response aggregation element';
$string['questions_for_response_aggregation'] = 'Questions for response aggregation';
$string['questions_to_aggregate'] = 'Select questions to aggregate';
$string['select_question_element'] = 'Select question element...';
$string['scale_value'] = '{scale value}';
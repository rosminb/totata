...
if ($hassiteconfig || has_capability('totara/oauth2:manageproviders', $systemcontext)) { // speedup for non-admins, add all caps used on this page
...
// Delete course completion logs after.
$temp->add(
    new admin_setting_configselect(

    ...
    protected function define_columnoptions() {
        ...
        $columnoptions = array(
            ...
            new rb_column_option(
                'primarypolicy',
                'applies_to',
                get_string('policyapplies_to', 'rb_source_tool_sitepolicy'),
                'policyversion.applies_to',
                array('joins' => 'policyversion',
                    'displayfunc' => 'sitepolicy_applies_to')),
    ...
    protected function define_filteroptions() {
        $filteroptions = array(
            ...
            new rb_filter_option(
                ...
                'multicheck', [
                    'selectchoices' => [
                        $applies_to = policyversion::APPLIES_TO_ALL => get_string("applies_to_{$applies_to}", 'tool_sitepolicy'),
                        $applies_to = policyversion::APPLIES_TO_AUTHENTICATED => get_string("applies_to_{$applies_to}", 'tool_sitepolicy'),
                        $applies_to = policyversion::APPLIES_TO_GUEST => get_string("applies_to_{$applies_to}", 'tool_sitepolicy'),
                    ],
                    'simplemode' => true,
                ]
            ),

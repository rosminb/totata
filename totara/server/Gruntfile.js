...
module.exports = function(grunt) {
    ...
    var getThirdPartyPathsFromXML = function() {
        var thirdpartyfiles = grunt.file.expand({matchBase: true}, '*/**/thirdpartylibs.xml', '!behatrun*/**');
    ...
    var getThemeStylelintIgnores = function() {
        var themeStylelintIgnoreFiles = grunt.file.expand({matchBase: true}, '!**/behatrun*/**', themeStylelintIgnores);
        var customIgnores = [];
    ...
    tasks.ignorefiles = function() {
        ...
        var eslintIgnores = ['# Generated by "grunt ignorefiles"', '*/**/yui/src/*/meta/', '*/**/build/', 'behatrun*/'].concat(thirdPartyPaths);
    ...
    tasks.shifter = function() {
        ...
        async.eachSeries(options.paths, function(src, filedone) {
            ...
            while (fs.existsSync('behatrun' + behatCount)) {
                args.push('--excludes', 'behatrun' + behatCount);
                behatCount++;
            }
            ...
            if (!options.recursive) {
                ...
                if (grunt.file.expand({cwd: src}, '!**/behatrun*/**', '**/yui/src/**/*.js').length > 0) {
                    args.push('--recursive');
                    execShifter();
                } else {
    ...
    tasks.gherkinlint = function() {
        ...
        var args = grunt.file.expand('!**/behatrun*/**', options.files);

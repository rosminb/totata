...
class report_builder_standard_saved_search_form extends moodleform {
    function definition() {
        ...
        $submitgroup = array();
        $submitgroup[] =& $mform->createElement('select', 'sid', get_string('availablesearcheslabel', 'totara_reportbuilder'), $savedoptions);
...
class report_builder_toolbar_search_form extends moodleform {
    public function definition() {
        ...
        // Save search button.
        if ($cansave) {
            $mform->addElement('submit', 'toolbarsavesearchbutton',
                get_string('savesearch', 'totara_reportbuilder'));
        }
    }

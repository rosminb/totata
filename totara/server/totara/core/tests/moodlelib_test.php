...
class totara_core_moodlelib_testcase extends advanced_testcase {
    ...
    public function data_provider_email_attachments(): array {
        return [
            [
                'attachment' => 'test.txt',
                'attachment_list' => [],
            ...
            [
                'attachment' => '',
                'attachment_list' => ['ical1.ics', 'ical2.ics'],
                'body_expected' => [
                    'This is a multi-part message in MIME format.',
                    'Content-Type: multipart/alternative',
            ...
            [
                'attachment' => 'ical1.ics',
                'attachment_list' => ['test.txt', 'ical2.ics'],
                'body_expected' => [
                    'This is a multi-part message in MIME format.',
                    'Content-Type: multipart/alternative',
                    'Content-Type: text/plain; name=test.txt',
    ...
    public function test_email_to_user_multiple_attachments() {
        ...
        static::assertStringContainsString('This is a multi-part message in MIME format.', $message->body);

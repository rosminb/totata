...
class totara_program_program_assignment_external_testcase extends advanced_testcase {
    ...
    public function test_set_includechildren_when_relative_time_active() {
        ...
        external::set_relative_due_date($setup->assignments[1]->id, $num, $period, $event, $eventinstanceid);

...
Feature: Set due date for program assignments
  ...
  Scenario: Relative due date related objects can have zero as value
    ...
    Then I should see "Complete within 0 Day(s) of date in profile field 'startdate'" in the "Jane Doe" "table_row"
    And  I should see "21 Oct" in the "Jane Doe" "table_row"

...
$string['content_provider'] = 'Content provider';
...
$string['error:cannot_find_course'] = 'Cannot find the course {$a}';
$string['error:cannot_find_section'] = 'Cannot find the section {$a}';
...
$string['explore_content_marketplace'] = 'Back to explore content marketplaces';
...
$string['provider_internal'] = 'Internal';

...
require(['core/autoinitialise'], function(ai) {
    ...
    public function get_top_of_body_code(core_renderer $renderer) {
        ...
        // Totara: add legacy browser polyfill, includes a polyfill for events, promises & fetch to allow us to use native es6 JS
        if (core_useragent::is_totara_legacy_browser()) {
            if ($CFG->debugdeveloper) {

...
class core_useragent {
     ...
     *
     * Both supported and unsupported browsers are included here, presence does
     * not neccesarily mean that a browser is officially supported.
     *
     * @return bool
     */
    public static function is_totara_legacy_browser(): bool {
        ...
        if (self::is_safari() && !self::check_safari_browser_version('13.1')) {
            return true;
        }
        if (self::is_webkit_ios() && !self::check_webkit_ios_platform_version('13.4')) {
            return true;
        }

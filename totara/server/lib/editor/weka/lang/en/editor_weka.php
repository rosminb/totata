...
$string['matching_placeholders'] = 'Matching placeholders';
$string['matching_users'] = 'Matching users';
$string['more_items'] = 'More';
$string['open_in_new_window'] = 'Open in new window';
$string['opens_in_new_window'] = 'Opens in new window';
$string['opens_in_new_windowx'] = '{$a} (opens in new window)';
$string['placeholder'] = 'Placeholder';
$string['pluginname'] = 'Weka editor';
$string['remove_link_target'] = 'Remove link';

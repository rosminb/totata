...
// Leave this function call for now to avoid unexpected failures on t16 and below.
if (!PHPUNIT_TEST && !(defined('BEHAT_SITE_RUNNING') && BEHAT_SITE_RUNNING) && !CLI_SCRIPT) {
